...
public class FetchLowerAustria extends AvalancheReport 
{
	private enum eState 
	{
		eNada0,
	...
	private eState mState = eState.eNada1;
    ...
    //-------------------------------------------------------------------------
	public FetchLowerAustria(ReportWriter rw)
	{
		mUrlStr = "http://www.lawinenwarndienst-niederoesterreich.at/lagebericht.php";
		mEncoding = "ISO-8859-1";
        mBitmapLocation = "http://www.lawinenwarndienst-niederoesterreich.at/noe_web.png";
		String tempImage = rw.GetDestinationDir() + "map.gif";
        mImgOnDevice = rw.GetDestinationDir() + "map.jpg";
		mCopyright = "Lawinenwarndienst Niederoesterreich";
		mDate = "";
        parse();
