...
public class FetchSalzburgEn extends AvalancheReport
{
	private enum eState 
	{
		eFindDate,
    ...
    //------------------------------------------------------------------------------	
	public FetchSalzburgEn(ReportWriter rw)
	{
		super();
		mUrlStr = "http://www.lawine.salzburg.at/lagebericht.asp?lang=en_UK"; 
		mEncoding = "UTF-8";
	...
	public void endElement(String uri, String localName, String name) throws SAXException
	{
		...
		switch (mState)
		{
			...
			case eDate:
				...
				{
					mDate = builder.toString().replace("Report", "");
			...
			case eUpdate:
				if (localName.equalsIgnoreCase("div"))
				{
					...
					mDate += " " + update.substring(0,update.indexOf('(')).replace("update", "").replace("today","");
			...
			switch (mState)
			{
				...
				case eContent: // ends with <script>
					if (localName.equalsIgnoreCase("script"))
					{
						...
						if (mContent.indexOf("Morning") == 0)
								mContent = mContent.substring(7);
